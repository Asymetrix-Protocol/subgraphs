...
import {
  createPromotionDestroyedEvent,
  createPromotionExtendedEvent,
  createPromotionCreatedEvent,
  createPromotionEndedEvent,
  createRewardsClaimedEvent,
} from './helpers/mockedEvent';

import {
  handlePromotionDestroyed,
  handlePromotionExtended,
  handlePromotionCreated,
  handlePromotionEnded,
  handleRewardsClaimed,
} from '../src/mappings/TWABRewards';
...
test('should handlePromotionExtended', () => {
  ...
  const promotionExtendedEvent = createPromotionExtendedEvent(promotionId, numberOfEpochs);
